const en = {
  ...
  personalSettings: {
    ...
    profile: {
      loadFailed: 'Failed to load your account details.',
      displayNameLabel: 'Display name',
      phoneLabel: 'Phone number',
      phonePlaceholder: 'Enter a phone number',
      avatarLabel: 'Avatar',
      avatarPlaceholder: 'https://example.com/avatar.png',
      avatarHint: 'Paste an image URL. Direct uploads are not supported yet.',
      emailHint: 'Sign-in email, cannot be changed.',
      userCodeLabel: 'User code',
      userCodeHint: 'Generated by the system so teammates can find you.',
      reset: 'Revert',
      submit: 'Save changes',
    },
    password: {
      description:
        'The new password needs at least 8 characters. Other devices stay signed in after the change.',
    ...
    validation: {
      ...
      avatarUrl: 'That is not a valid image URL',
