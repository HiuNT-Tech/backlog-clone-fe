const vi = {
  ...
  personalSettings: {
    ...
    profile: {
      loadFailed: 'Tải thông tin tài khoản thất bại.',
      displayNameLabel: 'Tên hiển thị',
      phoneLabel: 'Số điện thoại',
      phonePlaceholder: 'Nhập số điện thoại',
      avatarLabel: 'Ảnh đại diện',
      avatarPlaceholder: 'https://example.com/avatar.png',
      avatarHint: 'Dán đường dẫn ảnh. Hiện chưa hỗ trợ tải ảnh lên trực tiếp.',
      emailHint: 'Email đăng nhập, không thể thay đổi.',
      userCodeLabel: 'Mã người dùng',
      userCodeHint: 'Mã do hệ thống sinh, dùng để đồng đội tìm bạn.',
      reset: 'Hoàn tác',
      submit: 'Lưu thay đổi',
    },
    password: {
      description:
        'Mật khẩu mới cần tối thiểu 8 ký tự. Sau khi đổi, các thiết bị khác vẫn giữ đăng nhập.',
    ...
    validation: {
      ...
      avatarUrl: 'Đường dẫn ảnh không hợp lệ',
      currentPasswordRequired: 'Vui lòng nhập mật khẩu hiện tại',
      newPasswordMin: 'Mật khẩu mới tối thiểu 8 ký tự',
